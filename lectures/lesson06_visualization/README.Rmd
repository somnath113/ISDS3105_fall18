...
ggplot(data = freqCasualties,aes(x = class,y = n, fill = gender))+
  ...
  xlab('Casualty Reason') +
  ylab('Total Casualty Count') +
  ggtitle('Barchart of casualties by class and gender')
...
```{r}
ggplot() +
  geom_point(data =  twitter_users, aes(x = Year, y = millions, color ='blue')) 
...
#3. pass the aesthetics from 2 to geom_line() and geom_point() 
...
ggplot(data = twitter_users, aes(x = Year, y = millions))+
  geom_line(color = 'red')+
  geom_line(data = sn_users,aes(x = year,y = facebook,color = 'facebook'),color = 'blue')
