...
```{r}
str(iphoneSales)
class(iphoneSales) # talks about the method 
typeof(iphoneSales) # how the object is stored in memory
```


Indexing works similarly to vectors, but note the difference between _extracting_ and _subsetting_:
